 ...
 */
WoW.prototype.achievementApi = {
  achievementCategoriesIndex: function achievementIndex({ ...args }) {
    return this.blizzard.get(`/data/wow/achievement-category/index`, args);
  },
  achievementCategory: function achievementCategory({ achievementCategoryId, ...args }) {
    return this.blizzard.get(`/data/wow/achievement-category/${achievementCategoryId}`, args);
  },
  achievementsIndex: function achievementsIndex({ ...args }) {
    return this.blizzard.get(`/data/wow/achievement/index`, args);
  },
  achievement: function achievement({ achievementId, ...args }) {
    return this.blizzard.get(`/data/wow/achievement/${achievementId}`, args);
  },
  achievementMedia: function achievementMedia({ achievementId, ...args }) {
    return this.blizzard.get(` /data/wow/media/achievement/${achievementId}`, args);
  },
};
 ...
 * @return {Promise} A thenable Promises/A+ reference
 */
WoW.prototype.auctionHouseApi = {
  auctions: function auctions({ connectedRealmId, ...args }) {
    return this.blizzard.get(`/data/wow/connected-realm/${connectedRealmId}/auctions`, args);
  },
};

WoW.prototype.azeriteEssenceApi = {
  index: function index({ ...args }) {
    return this.blizzard.get(`/data/wow/azerite-essence/index`, args);
  },
  azeriteEssence: function azeriteEssence({ azeriteEssenceId, ...args }) {
    return this.blizzard.get(`/data/wow/azerite-essence/${azeriteEssenceId}`, args);
  },
  azeriteEssenceSearch: function azeriteEssenceSearch({ ...args }) {
    // TODO
    return this.blizzard.get(`/data/wow/search/azerite-essence`, args);
  },
  azeriteEssenceMedia: function azeriteEssenceMedia({ azeriteEssenceId, ...args }) {
    return this.blizzard.get(`/data/wow/media/azerite-essence/${azeriteEssenceId}`, args);
  },
};

WoW.prototype.connectedRealmApi = {
  connectedRealmIndex: function connectedRealmIndex({ ...args }) {
    return this.blizzard.get(`/data/wow/connected-realm/index`, args);
  },
  connectedRealm: function connectedRealm({ connectedRealmId, ...args }) {
    return this.blizzard.get(`/data/wow/connected-realm/${connectedRealmId}`, args);
  },
  connectedRealmsSearch: function connectedRealmsSearch({ ...args }) {
    // TODO
    return this.blizzard.get(`/data/wow/search/connected-realm`, args);
  },
};

WoW.prototype.covenantApi = {
  covenantIndex: function covenantIndex({ ...args }) {
    return this.blizzard.get(`/data/wow/covenant/index`, args);
  },
  covenant: function covenant({ covenantId, ...args }) {
    return this.blizzard.get(`/data/wow/covenant/${covenantId}`, args);
  },
  covenantMedia: function covenantMedia({ covenantId, ...args }) {
    return this.blizzard.get(`/data/wow/media/covenant/${covenantId}`, args);
  },
  soulbindIndex: function soulbindIndex({ ...args }) {
    return this.blizzard.get(`/data/wow/covenant/soulbind/index`, args);
  },
  soulbind: function soulbind({ soulbindId, ...args }) {
    return this.blizzard.get(`/data/wow/covenant/soulbind/${soulbindId}`, args);
  },
  conduitIndex: function conduitIndex({ ...args }) {
    return this.blizzard.get(`/data/wow/covenant/conduit/index`, args);
  },
  conduit: function conduit({ conduitId, ...args }) {
    return this.blizzard.get(`/data/wow/covenant/conduit/${conduitId}`, args);
  },
};

WoW.prototype.creatureApi = {
  creatureFamiliesIndex: function creatureFamiliesIndex({ ...args }) {
    return this.blizzard.get(`/data/wow/creature-family/index`, args);
  },
  creatureFamily: function creatureFamily({ creatureFamilyId, ...args }) {
    return this.blizzard.get(`/data/wow/creature-family/${creatureFamilyId}`, args);
  },
  creatureTypesIndex: function creatureTypesIndex({ ...args }) {
    return this.blizzard.get(`/data/wow/creature-type/index`, args);
  },
  creatureType: function creatureType({ creatureTypeId, ...args }) {
    return this.blizzard.get(`/data/wow/creature-type/${creatureTypeId}`, args);
  },
  creature: function creature({ creatureId, ...args }) {
    return this.blizzard.get(`/data/wow/creature/${creatureId}`, args);
  },
  creatureSearch: function creatureSearch({ ...args }) {
    return this.blizzard.get(`/data/wow/search/creature`, args);
  },
  creatureDisplayMedia: function creatureDisplayMedia({ creatureDisplayId, ...args }) {
    return this.blizzard.get(`/data/wow/media/creature-display/${creatureDisplayId}`, args);
  },
  creatureFamilyMedia: function creatureFamilyMedia({ creatureFamilyId, ...args }) {
    return this.blizzard.get(`/data/wow/media/creature-family/${creatureFamilyId} `, args);
  },
};

WoW.prototype.guildCrestApi = {
  guildCrestComponentsIndex: function guildCrestComponentsIndex({ ...args }) {
    this.blizzard.get(`/data/wow/guild-crest/index`, args);
  },
  guildCrestBorderMedia: function guildCrestBorderMedia({ borderId, ...args }) {
    this.blizzard.get(`/data/wow/media/guild-crest/border/${borderId}`, args);
  },
  guildCrestEmblemMedia: function guildCrestEmblemMedia({ emblemId, ...args }) {
    return this.blizzard.get(`/data/wow/media/guild-crest/emblem/${emblemId}`, args);
  },
};
